...
module control_shares_with_keccak_DOM #(
    ...
    generate 
        if(N_SHARES == 2) begin
            ...
            wire [3199:0] lfsr_keccak = {lfsr_out, keccak_in}; // 2 x 1600 bits
            always @(posedge clk) begin
                if(!rst | rst_op) begin
                    rand_k_1    <= 0;
                    rand_k_2    <= 0;
                    ...
                    rand_k_1   <= {4{lfsr_keccak[1*400-1:0*400]}}; // new value every cycle
                    rand_k_2   <= {4{lfsr_keccak[2*400-1:1*400]}};
                    rand_k_3   <= {4{lfsr_keccak[3*400-1:2*400]}};
                    rand_chi_1 <= {4{lfsr_keccak[4*400-1:3*400]}};
                    rand_chi_2 <= {4{lfsr_keccak[5*400-1:4*400]}};
                    rand_chi_3 <= {4{lfsr_keccak[6*400-1:5*400]}};
                    rand_chi_4 <= {4{lfsr_keccak[7*400-1:6*400]}};
                    rand_chi_5 <= {4{lfsr_keccak[8*400-1:7*400]}};
                    rand_chi_6 <= {{lfsr_keccak[1800-1:200]}, {lfsr_keccak[2000-1:1800]}, {lfsr_keccak[2200-1:2000]}, {lfsr_keccak[2400-1:2200]}, {lfsr_keccak[2600-1:2400]}, {lfsr_keccak[2800-1:2600]}, {lfsr_keccak[3000-1:2800]}, {lfsr_keccak[3200-1:3000]}}; 
                end
            end
            ...
            for (i = 0; i < 50; i = i + 1) begin
                always @(posedge clk) begin
                    if(!rst | rst_op) begin
                        ...
                        rand_k_2[i*32+:32]    <= 0;
                        rand_k_3[i*32+:32]    <= 0;
                        rand_chi_1[i*32+:32]  <= 0;
                        rand_chi_2[i*32+:32]  <= 0;
                        rand_chi_3[i*32+:32]  <= 0;
                        rand_chi_4[i*32+:32]  <= 0;
                        rand_chi_5[i*32+:32]  <= 0;
                        rand_chi_6[i*32+:32]  <= 0;
                    end
                    else begin
                        rand_k_1[i*32+:32]   <= $random; // new value every cycle
                        rand_k_2[i*32+:32]   <= $random;
                        rand_k_3[i*32+:32]   <= $random;
                        rand_chi_1[i*32+:32] <= $random;
                        rand_chi_2[i*32+:32] <= $random;
                        rand_chi_3[i*32+:32] <= $random;
                        rand_chi_4[i*32+:32] <= $random;
                        rand_chi_5[i*32+:32] <= $random;
                        rand_chi_6[i*32+:32] <= $random;  
                    end
                end
            end
            */
