...
module CBD_MASKED_DOM_SDRR #(
    ...
    reg [1095:0] reg_shake_s_1_0;
    reg [1095:0] reg_shake_s_1_1;
    always @(posedge clk) begin
        if(!rst) begin 
            reg_shake_s_1_0 <= {2{rand_1[547:0]}};
            reg_shake_s_1_1 <= {2{rand_1[1095:548]}};
        end
        else begin
            if(load) begin
                if(scnd)                    reg_shake_s_1_0 <= {in_shake_s_1, reg_shake_s_1_0[7:0]};
                else                        reg_shake_s_1_0 <= {8'h00, in_shake_s_1};
                
                reg_shake_s_1_1 <= {2{rand_1[1095:548]}};
            end                 
            else if(start_clk & !end_op & (sel_s == 2'b00)) begin
                if(eta == 2'b11)            reg_shake_s_1_1 <= (reg_shake_s_1_0 >> 24) ^ (mask & {2{rand_1[547:0]}});
                else                        reg_shake_s_1_1 <= (reg_shake_s_1_0 >> 16) ^ (mask & {2{rand_1[547:0]}});
                
                reg_shake_s_1_0 <= {2{rand_1[1095:548]}};
            end  
            else if(start_clk & !end_op & (sel_s == 2'b11)) begin
                reg_shake_s_1_0 <= reg_shake_s_1_1;
                reg_shake_s_1_1 <= {2{rand_1[1095:548]}};
            end          
            else begin
                reg_shake_s_1_0 <= reg_shake_s_1_0;
                reg_shake_s_1_1 <= reg_shake_s_1_1;
            end          
        end
    end

    reg [1095:0] reg_shake_s_2_0;
    reg [1095:0] reg_shake_s_2_1;
    always @(posedge clk) begin
        if(!rst) begin 
            reg_shake_s_2_0 <= {2{rand_1[1095:548]}};
            reg_shake_s_2_1 <= {rand_2[1095:0], rand_1[1599:1096]};
        end
        else begin
            if(load) begin
                if(scnd)                    reg_shake_s_2_0 <= {in_shake_s_2, reg_shake_s_2_0[7:0]};
                else                        reg_shake_s_2_0 <= {8'h00, in_shake_s_2};
                
                reg_shake_s_2_1 <= {rand_2[1095:0], rand_1[1599:1096]};
            end                 
            else if(start_clk & !end_op & (sel_s == 2'b00)) begin
                if(eta == 2'b11)            reg_shake_s_2_1 <= (reg_shake_s_2_0 >> 24) ^ (mask & {2{rand_1[1095:548]}});
                else                        reg_shake_s_2_1 <= (reg_shake_s_2_0 >> 16) ^ (mask & {2{rand_1[1095:548]}});
                
                reg_shake_s_2_0 <= {rand_2[1095:0], rand_1[1599:1096]};
            end           
            else if(start_clk & !end_op & (sel_s == 2'b11)) begin
                reg_shake_s_2_0 <= reg_shake_s_2_1;
                reg_shake_s_2_1 <= {rand_2[1095:0], rand_1[1599:1096]};
            end          
            else begin
                reg_shake_s_2_0 <= reg_shake_s_2_0;
                reg_shake_s_2_1 <= reg_shake_s_2_1;
            end 
        end
    end
    
    reg [1095:0] reg_shake_s_3_0;
    reg [1095:0] reg_shake_s_3_1;
    always @(posedge clk) begin
        if(!rst) begin 
            reg_shake_s_3_0 <= {rand_2[1095:0], rand_1[1599:1096]};
            reg_shake_s_3_1 <= {2{rand_1[547:0]}};
        end
        else begin
            if(load_clk) begin
                if(scnd)                    reg_shake_s_3_0 <= {in_shake_s_3, reg_shake_s_3_0[7:0]};
                else                        reg_shake_s_3_0 <= {8'h00, in_shake_s_3};
                
                 reg_shake_s_3_1 <= {2{rand_1[547:0]}};
            end                 
            else if(start_clk & !end_op & (sel_s == 2'b00)) begin
                if(eta == 2'b11)            reg_shake_s_3_1 <= (reg_shake_s_3_0 >> 24) ^ (mask & {rand_2[1095:0], rand_1[1599:1096]});
                else                        reg_shake_s_3_1 <= (reg_shake_s_3_0 >> 16) ^ (mask & {rand_2[1095:0], rand_1[1599:1096]});
            
                reg_shake_s_3_0 <= {2{rand_1[547:0]}};
            end   
            else if(start_clk & !end_op & (sel_s == 2'b11)) begin
                reg_shake_s_3_0 <= reg_shake_s_3_1;
                reg_shake_s_3_1 <= {rand_2[1095:0], rand_1[1599:1096]};
            end          
            else begin
                reg_shake_s_3_0 <= reg_shake_s_3_0;
                reg_shake_s_3_1 <= reg_shake_s_3_1;
            end         
        end
    end
    
    reg [1095:0] reg_shake_s_4_0;
    reg [1095:0] reg_shake_s_4_1;
    always @(posedge clk) begin
        if(!rst) begin 
            reg_shake_s_4_0 <= {rand_3[1095:0], rand_2[1599:1096]};
            reg_shake_s_4_1 <= {2{rand_1[547:0]}};
        end
        else begin
            if(load_clk) begin
                if(scnd)                    reg_shake_s_4_0 <= {in_shake_s_4, reg_shake_s_4_0[7:0]};
                else                        reg_shake_s_4_0 <= {8'h00, in_shake_s_4};
                
                 reg_shake_s_4_1 <= {2{rand_1[547:0]}};
            end                 
            else if(start_clk & !end_op & (sel_s == 2'b00)) begin
                if(eta == 2'b11)            reg_shake_s_4_1 <= (reg_shake_s_4_0 >> 24) ^ (mask & {rand_3[1095:0], rand_2[1599:1096]});
                else                        reg_shake_s_4_1 <= (reg_shake_s_4_0 >> 16) ^ (mask & {rand_3[1095:0], rand_2[1599:1096]});
            
                reg_shake_s_4_0 <= {2{rand_1[547:0]}};
            end   
            else if(start_clk & !end_op & (sel_s == 2'b11)) begin
                reg_shake_s_4_0 <= reg_shake_s_4_1;
                reg_shake_s_4_1 <= {2{rand_1[547:0]}};
            end          
            else begin
                reg_shake_s_4_0 <= reg_shake_s_4_0;
                reg_shake_s_4_1 <= reg_shake_s_4_1;
            end         
        end
    end
    ...
    (* DONT_TOUCH = "TRUE" *) reg [23:0] reg_shake, reg_shake_h;
    always @(posedge clk) begin
        if(!rst | !start_clk | (sel_s == 2'b11)) begin // SDRR operation (sel_s == 2'b11)
            reg_shake   <= rand_1[23:00] ^ rand_3[23:00]; 
            reg_shake_h <= rand_2[23:00] ^ rand_3[45:24]; 
        end
        else begin
            if(sel_s == 2'b00) begin
                reg_shake   <= reg_shake_s_1_0[23:0] ^ reg_shake_s_2_0[23:0] ^ reg_shake_s_3_0[23:0] ^ reg_shake_s_4_0[23:0];
                reg_shake_h <= reg_shake_s_1_1[23:0] ^ reg_shake_s_2_1[23:0] ^ reg_shake_s_3_1[23:0] ^ reg_shake_s_4_1[23:0];
            end
            else begin
                reg_shake <= reg_shake;
                reg_shake_h <= reg_shake_h;
            end
        end
    end
...
module CBD_MASKED_TI3_SDRR #(
    ...
    always @(posedge clk) begin
        if(!rst | load)                     sel_mask <= 1'b0;
        else if(sel_s == 2'b11 & sdrr_clk)  sel_mask <= ~sel_mask;
        else                                sel_mask <= sel_mask;
    end
    ...
    always @(posedge clk) begin
        if(!rst | !start_clk | (sel_s == 2'b11)) begin // SDRR operation (sel_s == 2'b11)
            ...
            if(sel_s == 2'b00) begin
                reg_shake   <= reg_shake_s_1_0[23:0] ^ reg_shake_s_2_0[23:0] ^ reg_shake_s_3_0[23:0];
                reg_shake_h <= reg_shake_s_1_1[23:0] ^ reg_shake_s_2_1[23:0] ^ reg_shake_s_3_1[23:0];
            end
            else begin
                reg_shake <= reg_shake;
                reg_shake_h <= reg_shake_h;
    ...
    */
    ...
    always @(posedge clk) begin
        if(!rst)                                                                ad_wr <= 0;
            ...
            if(start_clk & start & !end_op & (sel_s == 2'b11))                  ad_wr <= ad_wr + 2;
            else                                                                ad_wr <= ad_wr;
        end
    end
