...
module ARITHMETIC_UNIT_N_BU_4 (
   ...
   assign ad_2_14 = add_ram[159:150];
    ...
    ENCODER_COMPRESS ENCODER_COMPRESS (
        .clk        (   clk             ),
        .rst        (   rst             ),
        .start      (   start_encoder   ),
        .mode       (   mode_encdec     ),
    ...
    // DECODER_DECOMPRESS DECODER_DECOMPRESS (
